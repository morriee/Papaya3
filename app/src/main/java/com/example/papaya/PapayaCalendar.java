...
public class PapayaCalendar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        materialCalendarView.addDecorators(     //달력에 효과를 줌
                new SundayDecorator(),
    ...
    private class ApiSimulator extends AsyncTask<Void, Void, List<CalendarDay>> {
        ...
        protected void onPostExecute(@NonNull List<CalendarDay> calendarDays) {
            ...
            materialCalendarView.addDecorator(new EventDecorator(Color.GREEN, calendarDays,PapayaCalendar.this));
        }
    }
}
